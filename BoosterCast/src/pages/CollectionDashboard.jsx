...
export default function CollectionDashboard() {
  const [summary, setSummary] = useState({
    unique: 0,
    uniqueSets: 0, // Added unique sets count
    total: 0,
    value: 0,
    unique_sets: 0,
    pokemon: 0,
  ...
  useEffect(() => {
    setCollection([
        { title: "Scarlet & Violet Base Set", count: 5, price_at_tcg: 4.25 },
        { title: "Paldea Evolved", count: 3, price_at_tcg: 4.75 },
        { title: "Obsidian Flames", count: 2, price_at_tcg: 5.0 },
        { title: "Crown Zenith", count: 6, price_at_tcg: 5.5 },
        { title: "Lost Origin", count: 4, price_at_tcg: 4.0 },
      ]);
      
    // New API call to fetch sets data

    setSets([
        { _id: "Scarlet & Violet Base Set", count: 5 },
        { _id: "Paldea Evolved", count: 3 },
        { _id: "Obsidian Flames", count: 2 },
        { _id: "Crown Zenith", count: 6 },
        { _id: "Lost Origin", count: 4 },
      ]);
  ...
  const handleExport = async (format) => {
    ...
    try {
      const response = await axios.get(`http://localhost:8000/reports/export/${format}`, {
